// ignore_for_file: non_constant_identifier_names, prefer_typing_uninitialized_variables, avoid_print, prefer_is_empty, unused_local_variable, file_names, sort_child_properties_last, use_key_in_widget_constructors, camel_case_types, library_private_types_in_public_api, prefer_const_constructors, empty_catches, prefer_interpolation_to_compose_strings
  ...
  validarDatos() async{
      try{
          ...
          if (usuario.docs.length!=0){
            ...
            if(cursor.get('Contraseña')==passwordCtrl.text){
     ...
     save();
        ...
        crossAxisAlignment: CrossAxisAlignment.end,
          children:  <Widget>[
            ...
            child:const Text('Olvidaste la Constraseña',style: TextStyle(fontSize: 25),)),
              ]
               ),
